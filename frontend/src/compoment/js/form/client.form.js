...
const ClientForm = ({id,handleClose}) => {
    ...
    const send=async(e)=>{
        ...
        try {
           ...
           const {data}= await axios.post("http://localhost:5000/client/addClient",dataToSend,config)
    ...
    const update=async(e,id)=>{
        ...
        try {
            ...
            const {data}=await axios.put(`http://localhost:5000/client/updateClient/${id}`,dataToSend,config)
